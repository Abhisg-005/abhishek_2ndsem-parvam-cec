...
* 2. function accepting parameters and return value 
* 3. function not accepting parameter but return a value 
* 4. function not accepting parameter and not return value
*/
